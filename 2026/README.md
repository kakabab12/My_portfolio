...
| # | 프로젝트 | 기간 | 형태 | 한 줄 설명 |
|:-:|---|:-:|:-:|---|
| **01** | [**광명테크 인턴 — 배리어프리 키오스크**](01.%20광명테크%20인턴%20-%20배리어프리%20키오스크/) | `07~08월` | **기업 인턴** | 손을 못 쓰는 사용자를 위해 고개와 입으로 마우스를 대신합니다. 웹캠 1대만 씁니다 |
...
헤드트래커(고개+입)와 손 제스처 두 방식이 있습니다. <b>배포 8GB→1.1GB, 렌더 19.8→10.4ms</b>처럼
측정해서 고친 기록이 남아 있습니다. 날짜별 개발일지 30여 편도 같이 있습니다</td></tr>
...
읽어 아두이노 로봇팔을 제어합니다. 전시를 앞두고 <b>CSI 포트가 고장 나서 USB 듀얼 카메라로 구조를 바꿔</b> 넘겼습니다.
