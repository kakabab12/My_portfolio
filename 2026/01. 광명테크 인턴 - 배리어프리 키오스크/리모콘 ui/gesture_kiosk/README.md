...
- ⚠ **실기로 커서를 움직여 본 적은 아직 없습니다.** 감도는 2D 좌표 기준으로
  맞춰 둔 값이라, 켜면 처음부터 다시 맞춰야 합니다
...
- **라이선스 (2026-08-27 갱신)**: 스택 전체가 상업 사용 가능 + 코드 공개(카피레프트) 의무 없음 —
  ...
  Apache·MIT 모두 라이선스 문서 동봉(배포물 내 고지)은 통상 절차 — 제품 화면 표시 의무는 없습니다.
  ...
  뿐 명시된 의존성이 아니었습니다). requirements.txt에 직접 추가하고 이 절에도 반영했습니다.
