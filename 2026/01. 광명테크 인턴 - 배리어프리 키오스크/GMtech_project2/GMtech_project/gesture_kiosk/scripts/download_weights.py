...
# chcp 65001 없이(터미널에서 직접 python scripts\download_weights.py) 실행하면
# 콘솔 코드페이지가 시스템 기본(cp949)로 남아 한글 print()가 UnicodeEncodeError를
# 낸다(2026-08-07 실측 — 다운로드 시작 전에 죽어 모델이 아예 안 받아짐)
