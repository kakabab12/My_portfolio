...
# 홍채(눈동자)·눈꺼풀 랜드마크 — 아이트래킹 모드 시선 비율 계산용 (2026-07-22 신설)
# LEFT/RIGHT는 위 LMK_LEFT_EYE_OUTER(33)/LMK_RIGHT_EYE_OUTER(263)과 같은 눈 그룹을 따른다
# (MediaPipe 표준 눈 랜드마크 그룹 — FACEMESH_RIGHT_EYE={33,133,159,145,...}/
# FACEMESH_LEFT_EYE={263,362,386,374,...}. 이 프로젝트의 좌/우 표기는 위 기존 상수의
# 규약을 그대로 이어간 것뿐 — src/postprocess/head_tracker.py의 시선 비율 계산은
# 어느 쪽이 진짜 "왼쪽"인지와 무관하게 코너 2점의 min/max로 계산해 좌우 표기 오류에도
# 안전하다)
LMK_LEFT_EYE_INNER = 133
LMK_LEFT_EYE_TOP = 159
LMK_LEFT_EYE_BOTTOM = 145
LMK_LEFT_IRIS_CENTER = 468

LMK_RIGHT_EYE_INNER = 362
LMK_RIGHT_EYE_TOP = 386
LMK_RIGHT_EYE_BOTTOM = 374
LMK_RIGHT_IRIS_CENTER = 473
