...
카메라로 물체를 인식해 **크기(대/중/소)와 불량 여부를 판정**하고, 결과를 아두이노로
보내 **분류기를 제어**합니다. 어려웠던 것은 인식 자체가 아니라
**그래픽카드 없는 라즈베리파이에서 YOLOv8-seg를 CPU로 돌리는 일**이었습니다.
...
같은 기능을 세 번 고쳐 만든 것이 그대로 남아 있습니다.
...
여기서 부딪힌 **"자원이 모자란 보드에서 AI를 어떻게 돌릴 것인가"** 라는 문제가
