...
from src.utils.visualize import draw_bbox, draw_person_lock, draw_status, draw_two_palm_hold
...
class GesturePipeline:
    ...
    def process(self, frame):
        ...
        annotated = draw_two_palm_hold(annotated, self.gesture_filter.two_palm_hold_ratio)
