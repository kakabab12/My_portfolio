"""capture 모듈 — USB/내장 웹캠에서 프레임을 실시간으로 읽어 온다.
...
def init_camera(config):
    ...
    # config(camera.windows_backend)로 dshow/msmf/auto를 고를 수 있게 한다
    ...
    # 무압축(YUY2) 720p는 USB 대역폭 한계로 캡처가 저FPS에 묶일 수 있다 — MJPG 기본
